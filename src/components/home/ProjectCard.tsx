...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  const icon = theme === "dark" && project.iconDark ? project.iconDark : project.icon;
    ...
    <motion.div variants={staggerItem}>
      <GlassCard hoverable className="p-4 flex items-center gap-4">
        {icon ? (
          ...
          <div className="w-12 h-12 rounded-xl flex-shrink-0 flex items-center justify-center text-lg font-semibold text-text-secondary" style={{ background: `linear-gradient(to bottom right, var(--icon-fallback-from), var(--icon-fallback-to))` }}>
            {project.name[0]}
          </div>
        )}
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          {project.links.github && (
            <IconButton href={project.links.github} label="GitHub">
          ...
          {project.links.appStore && (
            <IconButton href={project.links.appStore} label="App Store">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          {project.links.website && (
            <IconButton href={project.links.website} label="Website">
